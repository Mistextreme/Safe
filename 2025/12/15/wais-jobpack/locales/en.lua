return {
    ...
    ["rubbish_cleared"] = "You're very good, what's left of the rubbish: %s",
    ...
    ["gardener_finish_return"] = "Finish Job / Return your vehicle",
    ["gardener_finish_return_desc"] = "Finish the job or return the vehicle to the centre",
    ...
    ["bus_goback_old_stop"] = "At the previous bus stop, the process was not completed!",
    ["bus_goback_curr_stop"] = "At the bus stop, the process is incomplete!",
    ["bus_no_free_seat"] = "The passenger could not board the vehicle because there were no empty seats.",
    ...
    ["bucket_up_down"] = "⬆ Up - ⬇ Down                      \n",
    ["bucket_left_right"] = "⬅ Left - ➡ Right           \n",
