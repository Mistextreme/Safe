local dui = CreateDui("https://r2.fivemanage.com/3zc6A4SmytOuMCc2CGUu6/Designsanstitre(6).png", 512, 128)
local Menuthing = GetDuiHandle(dui)
dui_txd = CreateRuntimeTxd('MenuGW')
txt = CreateRuntimeTextureFromDuiHandle(dui_txd, 'MenuGW', Menuthing)
...
function RageUI.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.Index = 1
    Menu.Sprite = { Dictionary =  "MenuGW", Texture = "MenuGW", Color = { R = 255, G = 255, B = 255, A = 255 } }
    Menu.Rectangle = nil
    Menu.Pagination = { Minimum = 1, Maximum = 10, Total = 13 }
    Menu.Safezone = true
