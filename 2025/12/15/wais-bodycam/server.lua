        ...
        if resultData ~= nil then
            ...
            if newversion == "error" or newversion == "dontfind" then
                ...
                if version == newversion then
                    ...
                    CreateThread(function()
                        while true do
                            print('^3There is a new version of the script you are using. ^3You can get the new version via Ayazwai#3900 or discord.gg/0resmon discord. [Script: ^1'..script..'^3 Version: ^1v'..version.. "^3 Avaible version: ^1v"..newversion.. "^3]")
                            print('^3If you have an open source script, you can get the new version by opening a ticket on discord. If you are an escrow script owner, you can update your script via keymaster.')
                            Wait(60 * 1000)
                        end
                    end)
                end
