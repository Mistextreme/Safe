...
type RecruitEmployeesModalProps = {
  onClose: () => void;
...
const RecruitEmployeesModal: React.FC<RecruitEmployeesModalProps> = ({
  onClose,
  onConfirm,
}) => {
...
export default RecruitEmployeesModal;
