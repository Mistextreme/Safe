...
local Slider = {
	...
	LeftArrow = { Dictionary = "fb-creator", Texture = "arrowleft", X = 12, Y = 32.5, Width = 25, Height = 25 },
	RightArrow = { Dictionary = "fb-creator", Texture = "arrowright", X = 389, Y = 32.5, Width = 25, Height = 25 },
}
...
function RageUI.SliderPanel(Value, MinValue, UpperText, MaxValue, Actions, Index)
	...
	if CurrentMenu ~= nil then
		if CurrentMenu() and ((CurrentMenu.Index == Index)) then
			...
			RenderSprite("fb-creator", "gradient_bgd", CurrentMenu.X, CurrentMenu.Y + Slider.Background.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, Slider.Background.Width + CurrentMenu.WidthOffset, Slider.Background.Height, 0.0, 255, 255, 255, 255)
