---@type table
local Colour = {
    Background = { Dictionary = "fb-creator", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 112 },
    LeftArrow = { Dictionary = "fb-creator", Texture = "arrowleft", X = 7.5, Y = 15, Width = 30, Height = 30 },
    RightArrow = { Dictionary = "fb-creator", Texture = "arrowright", X = 393.5, Y = 15, Width = 30, Height = 30 },
