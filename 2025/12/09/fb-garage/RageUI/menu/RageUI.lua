...
RageUI.Settings = {
    ...
    Items = {
        ...
        Background = { Dictionary = "fb-creator", Texture = "gradient_bgd", Y = 0, Width = 431 },
        Navigation = {
            Rectangle = { Width = 431, Height = 18 },
            Offset = 5,
            Arrows = { Dictionary = "fb-creator", Texture = "shop_arrows_upanddown", X = 190, Y = -6, Width = 50, Height = 50 },
        },
        Description = {
            Bar = { Y = 4, Width = 431, Height = 4 },
            Background = { Dictionary = "fb-creator", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 30 },
            Text = { X = 8, Y = 10, Scale = 0.35 },
        },
    },
    Panels = {
        Grid = {
            Background = { Dictionary = "fb-creator", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 275 },
        ...
        Percentage = {
            Background = { Dictionary = "fb-creator", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 76 },
        ...
        if CurrentMenu() and (CurrentMenu.Display.Header) then
            ...
            if CurrentMenu.Sprite ~= nil then
                if CurrentMenu.Sprite.Dictionary ~= nil then
                    if CurrentMenu.Sprite.Dictionary == "fb-creator" then
