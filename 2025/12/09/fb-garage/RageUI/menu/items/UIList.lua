...
---@type table
local SettingsList = {
    LeftArrow = { Dictionary = "fb-creator", Texture = "arrowleft", X = 378, Y = 3, Width = 30, Height = 30 },
    RightArrow = { Dictionary = "fb-creator", Texture = "arrowright", X = 400, Y = 3, Width = 30, Height = 30 },
