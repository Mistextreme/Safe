...
function RageUI.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.Index = 1
    Menu.Sprite = { Dictionary = TextureDictionary or "fb-creator", Texture = TextureName or "interaction_bgd", Color = { R = R, G = G, B = B, A = A } }
    Menu.Rectangle = nil
...
function RageUI.Menus:EditSpriteColor(R, G, B, A)
    if self.Sprite.Dictionary == "fb-creator" then
...
function RageUI.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "fb-creator", Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end
